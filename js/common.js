...
function getCount() {
    $.ajax({
        type: "get",
        url: "http://gyh5.bandu.tv/sys_demo/customer/share_history/getCount",
        data: {},
        async: false,
        cache: false,
...
var host = "http://gyh5.bandu.tv/sys_demo/";
function setJSAPI(share_img) {
    // 获取签名以调用api
    const getSignature = host + "wx/generateConfig";
